...
function App() {
  ...
  useEffect(() => {
    ...
    // Debounce fast typing so we don't write on every keystroke, but never
    // let more than 1.5s of unsaved changes sit in memory — if the tab is
    // refreshed or closed mid-debounce, this is what actually gets lost.
    ...
    writeTimerRef.current = setTimeout(flush, 500);
